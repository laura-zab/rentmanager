...
<!-- /vehicles/create -->
<form class="form-horizontal" method="post" action="/rentmanager/vehicles/edit?id=${vehicle.id}">
<div class="box-body">
...
<div class="col-sm-10">
<input type="text" class="form-control" id="seats" name="seats" value="${vehicle.nb_places}">
</div>
</div>
